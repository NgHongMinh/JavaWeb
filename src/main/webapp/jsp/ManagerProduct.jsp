...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                        	<a href="#listCategory"  class="btn btn-success" data-toggle="modal"> <span>List Category</span></a>	                        
            ...
            <a href="products"><button type="button" class="btn btn-primary">Back to home</button></a>
        </div>
        <!-- Edit Modal HTML -->
        <div id="addCategory" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="categories?action=createPost" method="post">
        ...
        <div id="listCategory" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="categories?action=createPost" method="post">
                        <div class="modal-header">						
                            <h4 class="modal-title">List of Category</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <table class="table table-striped table-hover">
                    <thead>
                    ...
                    <tbody>
                        <c:forEach items="${categories}" var="o">
                            <tr>
                                ...
                                <td>${o.name}</td>
                                <td>
                                	<a href="loadCategory?cid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                </td>                                	
                            </tr>
                        </c:forEach>
                    </tbody>
        ...
        <div id="addProduct" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="manager?action=createPost" method="post">
                        <div class="modal-header">						
    ...
    <script src="js/categoryEdit.js" type="text/javascript"></script>
</body>
</html>